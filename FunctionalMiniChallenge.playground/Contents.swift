...
let freshmanStudents = students.filter {$0.year == StudentYear.freshman}

//for student in freshmanStudents {
...
let fullNameStudents = students.map{(person: Student) -> String in
    return "\(person.firstName) \(person.lastName)"
}

//for student in fullNameStudents {
//    print(student)
//}
...
var totalSum = students.reduce(0, {$0 + $1.grade})

print("Cumulative Class Score: \(totalSum)")
print("Class Average: \(totalSum/count)%")
